...
/**
 * Renders a section of a webpage that outlines the missions of an organization.
 * @returns {JSX.Element} JSX element that renders the mission section of a webpage with a title, button, and a list of missions.
 */
  ...
  const Missions = [
    {
      key: 0,
      Icon: StudentsIcon,
      Title: `Partage de l'Évangile et Expansion de la Foi Chrétienne`,
    ...
    },
    {
      key: 1,
      Icon: ChartIcon,
      Title: `Soutien aux Communautés et Promotion du Bien-être Social`,
    ...
    },
    {
      key: 2,
      Icon: CrossIcon,
      Title: `Développement de l'Éducation et Formation des Jeunes`,
      ...
      {Missions.map((Mission) => (
        <Container className="flex flex-col" key={Mission.key}>
          <div className="w-full grid grid-cols-2 gap-5">
            <div className="w-10">
              <img src={Mission.Icon} alt="Icon" className="" />
            </div>
